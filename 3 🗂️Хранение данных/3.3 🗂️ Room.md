...
![Roombd.png](..\Roombd.png)
**Основные компоненты Room:**

1. **Entity (Сущность)** — как таблица в Excel.

1. **DAO (Data Access Object)** — набор команд для работы с таблицей (добавить, удалить, получить данные).

1. **Database** — сама база данных, которая связывает все таблицы и DAO.
